...
//                                    .nameSet(@"2020")
        ...
        if (self.chartType == SecondeViewControllerChartTypeSpline) {
            ...
            _aaChartModel.series = @[
                                     ...
                                     .nameSet(@"2017")
                                     .lineWidthSet(@5)
                                     .dataSet(@[@50, @320, @230, @370, @230, @400,@80, @390, @210, @340, @240, @350,@80, @390, @210, @340, @240, @350,@80, @390, @210, @340, @240, @350,@80, @390, @210, @340, @240, @350,]),
                                     AAObject(AASeriesElement)
                                     .nameSet(@"2018")
                                     .lineWidthSet(@5)
                                     .dataSet(@[@80, @390, @210, @340, @240, @350,@100, @370, @180, @280, @260, @300,@100, @370, @180, @280, @260, @300,@100, @370, @180, @280, @260, @300,@100, @370, @180, @280, @260, @300,]),
                                     AAObject(AASeriesElement)
                                     .nameSet(@"2019")
                                     .lineWidthSet(@5)
                                     .dataSet(@[@100, @370, @180, @280, @260, @300,@130, @350, @160, @310, @250, @268,@130, @350, @160, @310, @250, @268,@130, @350, @160, @310, @250, @268,@130, @350, @160, @310, @250, @268,]),
                                     AAObject(AASeriesElement)
                                     .nameSet(@"2020")
                                     .lineWidthSet(@5)
                                     .dataSet(@[@130, @350, @160, @310, @250, @268,@130, @350, @160, @310, @250, @268,@130, @350, @160, @310, @250, @268,@130, @350, @160, @310, @250, @268,@130, @350, @160, @310, @250, @268,]),
                                     ];        }
